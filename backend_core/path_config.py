...
IMAGE_BUNDLED_DATA_DIR = ROOT / "bootstrap-data"
LOCAL_BUNDLED_DATA_DIR = ROOT / "data"
BUNDLED_DATA_DIR = IMAGE_BUNDLED_DATA_DIR if IMAGE_BUNDLED_DATA_DIR.exists() else LOCAL_BUNDLED_DATA_DIR
...
BUNDLED_DATASET_PATH = (
    BUNDLED_DATA_DIR / DATASET_FILENAME
    if (BUNDLED_DATA_DIR / DATASET_FILENAME).exists()
    else ROOT / DATASET_FILENAME
)
